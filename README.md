...
- [깃허브 모바일 어플리케이션으로 출시가 되었습니다!](https://github.com/mobile?utm_source=announcement&utm_medium=email&utm_campaign=mobileGA)
- [프로그래밍 언어 랭킹](https://www.tiobe.com/tiobe-index/)
...
- [공적데이터를 활용한 마스크 찾기 사이트](https://finding-mask.firebaseapp.com/)
- [개발자를 위한 레디스 튜토리얼](https://meetup.toast.com/posts/224)
- [Monolithic 서버사이드 타입스크립트 세팅](https://changhoi.github.io/posts/etc/serverside-typescript-setting-01/)
- [초보 개발자를 위한 IT영단어 정리](https://brunch.co.kr/@hopeless/8)
- [자바 EE, Servlet, ServletContext 등 개념](https://jordy-torvalds.tistory.com/m/14)
...
- [AWS Developer Associate 취득 후기](https://blog.wonizz.tk/2020/03/02/certification-aws-developer-associate/)
...
- [Springboot2 + log4j2 + slackappender](https://medium.com/@kevin_park/springboot2-log4j2-slackappender-3bd6bc8360af)
- [뱅크샐러드 재택 근무 생산성](https://blog.banksalad.com/tech/work-from-home/)
- [파이썬으로 디스코드 봇 만들기](https://code-200.tistory.com/58)
- [1분 코딩](https://studiomeal.com/product)
- [DNS 동작 이해](https://brunch.co.kr/@topasvga/196)
